...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <a href="#"><img src="assets/img/carrossel/actionFigures/img1.png" class="d-block w-100" alt="imagem carrossel 1"></a>
        </div>
        <div class="carousel-item">
            <a href="#"><img src="assets/img/carrossel/actionFigures/img2.png" class="d-block w-100" alt="imagem carrossel 2"></a>
        </div>
        <div class="carousel-item">
            <a href="#"><img src="assets/img/carrossel/actionFigures/img3.png" class="d-block w-100" alt="imagem carrossel 3"></a>
        </div>
    </div>
...
<div class="container-fluid pagina-produtos">
    <div class="row">
        ...
        <section class="col-lg-9 col-md-8 area-produtos">
            <h2 class="h2 text-center">⚔️ Traga o seu personagem favorito direto do anime para a sua estante!</h2>
